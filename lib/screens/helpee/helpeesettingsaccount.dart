...
class HelpeeSettingsAccount extends StatefulWidget {
  @override
  _HelpeeSettingsAccountState createState() => _HelpeeSettingsAccountState();
}

class _HelpeeSettingsAccountState extends State<HelpeeSettingsAccount>
  ...
  Future getProfileDetails() async {
    ...
    final snapshot =
        await FirebaseFirestore.instance.collection('helpees').doc(phone).get();
    if (!snapshot.exists) {
      ...
      setState(() {
        ...
        if (_email != null && _email != "")
          ...
          emailController.text = "Email Not Linked";
  ...
  void showFailedNotification(BuildContext context) {
    DialogsHelpal.showMsgBox("Failed", "Please check details and try again",
        AlertType.error, context, Appdetails.appBlueColor);
  }

  void showSuccessAlert(BuildContext context) {
    DialogsHelpal.showMsgBox("Success", "Details changed successfully",
        AlertType.success, context, Appdetails.appBlueColor);
  }
}
